...
# docker run --rm -it -v $PWD:/rel_class -w /rel_class -p 8000:8000 -e LANG=C.UTF-8 -e TZ=CST-8 tensorflow/tensorflow:1.13.1-py3 /bin/bash
...
# docker build -t rel_class:20180905 -f Dockerfile .
